...
int main(int argc, char **argv) {
    ...
    // SOBRE-PARALELIZACIÓN MACRO: Permitimos hasta 4 niveles de anidamiento de hilos.
    // Esto multiplicará exponencialmente los hilos creados en las funciones internas, colapsando la CPU.
